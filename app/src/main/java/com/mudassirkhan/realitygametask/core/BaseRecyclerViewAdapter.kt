...
import com.mudassirkhan.realitygametask.BR

abstract class BaseRecyclerViewAdapter<T> internal constructor(private val itemClickListener: OnItemClickListener<T>?) :
